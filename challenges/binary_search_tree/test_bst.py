...
def test_insert_value_into_existing_tree(small_tree):
    '''test verifies that insert value into eisting tree
    '''
    assert small_tree.root.right.right.left.left.value == 26
